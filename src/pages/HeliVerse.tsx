    ...
    <div className="container py-4 py-lg-7">
      <div className="d-flex justify-content-center">
        <div className="container-max-with-1042">
          <h2 className="text-subheader text-bold">Meet the HeliVerse:</h2>
          <p className="text-main mt-4">
            One of our missions is to expand and increase the utility of the HELI token and to drive
            use cases to the HeliSwap Platform. As such, we are bringing a new product to Hedera
            that will be closely intertwined with the main HeliSwap DEX, while standing on its own
            in terms of branding, value proposition and usage.{' '}
          ...
          <p className="text-main mt-4">
            ...
            future. Any event with a definite outcome can serve as an underlying prediction. How
            much will HBAR be worth in 2 months at a given date and time? Will HEDERA reach 25B
            transactions by the end of the year? Will Manchester City win the Champions League? Will
            Donald Trump be allowed to run as a presidential candidate? How many people will be
            living on earth by the end of this year according to the PRB?
            <br />
            <br />
          ...
          <p className="text-main mt-4">
            The HeliVerse will show leaderboards and a fun level-up system with cool HeliVerse
            avatar NFTs to unlock at each stage. First users to reach the last level will win extra
          ...
          <p className="text-main mt-4">
            While our team continuously works on bringing new use cases to the HeliVerse, we are
            also working with partner projects on Hedera that want to include HELI on their platform
            in some form. Those projects can become “HeliVerse Partners” and we will also be able to
