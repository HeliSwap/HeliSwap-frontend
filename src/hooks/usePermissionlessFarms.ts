...
import { GET_PERMISSIONLESS_FARMS } from '../GraphQL/Queries';
...
const usePermissionlessFarms = (
  ...
  const { loading, data, error, startPolling, stopPolling } = useQuery(GET_PERMISSIONLESS_FARMS, {
...
export default usePermissionlessFarms;
